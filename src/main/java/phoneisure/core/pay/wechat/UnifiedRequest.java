...
import phoneisure.core.pay.wechat.util.RandomStringGenerator;
...
public class UnifiedRequest {
    ...
    public UnifiedRequest(String body, String detail, String out_trade_no, int total_fee, String spbill_create_ip, String notify_url,String openid) {
