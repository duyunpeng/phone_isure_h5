...
[@mc.showAlert /]
    ...
    <div class="nav">
        <ul class="clearfix">
            ...
            <li class="no"><a href="[@spring.url '/policy/claim_list'/]">理赔查询</a><span class="policy_claim light-green badge"></span></li>
        </ul>
    </div>
    <!--查询-->
    <div class="query clearfix">
        <form action="/policy/claim_list" method="post">
    ...
    [#if pagination!]
        [@mc.showPagination '/policy/claim_list' /]
    [/#if]
    </div>
</div>
