...
<header>
    <div class="heade">
        ...
        <div class="header-right">
            <div class="text-right"><a href="/logout">退出</a> &nbsp;&nbsp;<a href="[@spring.url '/merchant/update_password'/]">设置</a></div>
...
[@mc.showAlert /]
    ...
    <div class="nav">
        <ul class="clearfix">
            <li><a href="[@spring.url '/policy/list'/]">保单查询</a><span class="policy_all green badge"></span></li>
            <li class="no"><a href="[@spring.url '/policy/return_list'/]">退单查询</a><span class="policy_back red badge"></span></li>
            <li><a href="[@spring.url '/policy/claim_list'/]">理赔查询</a><span class="policy_claim light-green badge"></span></li>
        </ul>
    </div>
    <!--查询-->
    <div class="query clearfix">
        <form action="/policy/return_list" method="post">
